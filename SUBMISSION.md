...
[0:32–0:48]  ON SCREEN: /api/of/demo — two polished cards rendered live from Salesforce; $185,000 Full option with the green "Recommended" ribbon; seats shown as $0. Cursor clicks "Accept" -> page reloads with "🎉 locked in" banner.
...
1. IMPACT — It does the real work: actual Salesforce Quote line items ($100k Lean + $185k Full) and a real Accept-to-close write-back. Not a mockup.
